...
const About = () => {
  return (
    <section id="about" className={`${LAYOUT.SECTION_PADDING} !bg-[#E1DBC9]`}>
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div variants={ANIMATION_VARIANTS.fadeInUp} className="flex flex-col items-center mb-12">
            <div className="relative mb-6">
              ...
              <div className="relative w-40 h-40 rounded-full overflow-hidden shadow-xl" style={{ border: '4px solid #C8C2AD' }}>
                <Image src={PERSONAL_INFO.headshot} alt={PERSONAL_INFO.name} fill className="object-cover" priority />
              </div>
            </div>
            <div className="text-center mb-4">
              <h3 className="text-2xl font-bold mb-2" style={{ color: '#1E2E20' }}>{PERSONAL_INFO.name}</h3>
              <p className="!text-[#2D4530] text-lg font-medium mb-1">{PERSONAL_INFO.year}</p>
              <p style={{ color: '#6B7B84' }}>{PERSONAL_INFO.school}</p>
            </div>
            <p className="text-center leading-relaxed max-w-2xl" style={{ color: '#4A5A4E' }}>{ABOUT.bio}</p>
          </motion.div>

          <motion.div variants={ANIMATION_VARIANTS.fadeInUp} className="mb-12">
            <h3 className="text-xl font-semibold mb-4 text-center" style={{ color: '#1E2E20' }}>Areas of Interest</h3>
