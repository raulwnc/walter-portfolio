...
const PresentationCard = ({ presentation, index }) => {
  return (
    <motion.div
      ...
      className="bg-white border-2 border-gray-200 p-6 rounded-xl hover:border-purple-300 hover:shadow-lg transition-all duration-300"
    >
...
const Presentations = () => {
  return (
    <section id="presentations" className={`${LAYOUT.SECTION_PADDING} bg-gray-50`}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            className="mt-8 p-6 bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-200 rounded-xl text-center"
          >
