...
const ResearchCard = ({ research, index }) => {
  return (
    <motion.div
      ...
      className="bg-white border-2 border-gray-200 p-6 sm:p-8 rounded-xl hover:border-blue-300 hover:shadow-lg transition-all duration-300"
    >
...
const Research = () => {
  return (
    <section id="research" className={`${LAYOUT.SECTION_PADDING} bg-white`}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-xl border border-blue-200"
          >
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600 mb-1">VR</div>
              <div className="text-sm text-gray-600">Innovation</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-1">FDA</div>
