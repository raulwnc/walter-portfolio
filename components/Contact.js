...
const Contact = () => {
  return (
    <section id="contact" className={`${LAYOUT.SECTION_PADDING} bg-gray-50 dark:bg-gray-800`}>
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <motion.div variants={ANIMATION_VARIANTS.fadeInLeft} className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${PERSONAL_INFO.email}`} className="text-blue-600 dark:text-blue-400 hover:underline text-sm">
                        {PERSONAL_INFO.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-1">LinkedIn</p>
                      <a href={PERSONAL_INFO.linkedin} target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline text-sm">
                        Connect on LinkedIn
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-2xl" aria-hidden="true">📄</span>
                    <div>
                      <p className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-1">Curriculum Vitae</p>
                      <a href={PERSONAL_INFO.cv} download target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline text-sm">
                        Download CV (PDF)
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-2xl" aria-hidden="true">📍</span>
                    <div>
                      <p className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-1">Location</p>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-6 rounded-xl border-2 border-blue-200 dark:border-blue-700">
